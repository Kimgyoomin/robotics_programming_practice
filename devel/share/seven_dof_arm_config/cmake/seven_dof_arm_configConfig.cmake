...
if("TRUE" STREQUAL "TRUE")
  set(seven_dof_arm_config_SOURCE_PREFIX /home/kim/kim_ws/src/seven_dof_arm_config)
  set(seven_dof_arm_config_DEVEL_PREFIX /home/kim/kim_ws/devel)
  ...
  set(seven_dof_arm_config_INSTALL_PREFIX /home/kim/kim_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://moveit.ros.org/ " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Kim <kimgyoomin1999@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'seven_dof_arm_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kim/kim_ws/src/seven_dof_arm_config/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kim/kim_ws/devel/lib;/home/kim/kim_ws/devel/lib;/opt/ros/noetic/lib)
